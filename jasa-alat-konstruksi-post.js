    ...
    function detectPageType(pageName) {
        ...
        for (const kw of MONEY_KEYWORDS) {
            ...
            if (lower.includes(kw)) {
                ...
                if (
                    wordCount <= 2 &&
                    !isSpecificProduct(afterKeyword)
                ) {
                    return 'money-master';
                }
 ...
 * → sub-pillar-tipe-2 ✅
 *
 * panel beton vs bata ringan
 * → sub-pillar-tipe-1 ✅
 *
 * spesifikasi panel beton
 * → variant ✅
 *
 * panel beton 10cm x 20cm x 100cm
 * → sub-variant ✅
 *
 * ================================================================
 */
