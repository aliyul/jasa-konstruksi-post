...
const urlMappingJasaTukangBorFromMoneyMaster1MoneyChild = {
  // ============================================================
...
const urlMappingJasaBorSumurFromMoneyMaster1MoneyChild = {
  ...
  "https://www.betonjayareadymix.com/2019/08/jasa-sumur-bor-depok.html": "Jasa Sumur Bor Depok",   
...
const urlMappingJasaBorePileFromMoneyMaster1MoneyChild = {
    ...
    "https://www.betonjayareadymix.com/2019/08/jasa-bore-pile-jakarta.html": "Jasa Bore Pile Jakarta",
    "https://www.betonjayareadymix.com/2019/08/jasa-bore-pile-bogor.html": "Jasa Bore Pile Bogor",
...
const urlMappingJasaCoringBetonFromMoneyMaster1MoneyChild = {
  ...
  "https://www.betonjayareadymix.com/2018/11/jasa-core-drill-beton-jakarta.html": "Jasa Core Drill Beton Jakarta",  
...
const urlMappingHargaJasaBorBetonFromMoneyPageMoneyChild = {
  "https://www.betonjayareadymix.com/2019/08/harga-jasa-bor-beton-jakarta.html": "Harga Jasa Bor Beton Jakarta",  
  "https://www.betonjayareadymix.com/2019/08/harga-jasa-bor-beton-bogor.html": "Harga Jasa Bor Beton Bogor",  
  "https://www.betonjayareadymix.com/2019/08/harga-jasa-bor-beton-depok.html": "Harga Jasa Bor Beton Depok",  
  "https://www.betonjayareadymix.com/2019/08/harga-jasa-bor-beton-tangerang.html": "Harga Jasa Bor Beton Tangerang",  
  "https://www.betonjayareadymix.com/2019/08/harga-jasa-bor-beton-bekasi.html": "Harga Jasa Bor Beton Bekasi",  
  "https://www.betonjayareadymix.com/2019/08/harga-jasa-bor-beton-karawang.html": "Harga Jasa Bor Beton Karawang",  
  "https://www.betonjayareadymix.com/2019/08/harga-jasa-bor-beton-surabaya.html": "Harga Jasa Bor Beton Surabaya"  
};
...
*/
    ...
    const urlMappingGabungan = Object.assign(
      {},
		...
		urlMappingHargaJasaBorBetonFromMoneyPageMoneyChild,
		...
		urlMappingJasaTukangBorFromMoneyMaster1MoneyChild
...
function loadSchemaScript() {
  return new Promise((resolve) => {
    ...
    const existing = document.querySelector('script[src*="schema-jasa"]');
    if (existing) {
      console.log('[Main] Schema already loaded');
      resolve();
      return;
    }

    const script = document.createElement('script');
    script.src = 'https://githubraw.com/aliyul/27574a4d1ce27eebe3432de3bb42bcfb/raw/5d1bf60a1787090b22830951fe9d2d8e9e1986a5/schema-jasa.js';
    script.async = true;

    script.onload = () => {
      console.log('[Main] ✅ Schema loaded');
      resolve();
    };

    script.onerror = () => {
      console.warn('[Main] ❌ Schema failed, using fallback');
      injectFallbackSchema();
      resolve();
    };
...
// ============================================================
// 2. FALLBACK SCHEMA (jika gagal load)
// ============================================================
function injectFallbackSchema() {
  const el = document.getElementById('auto-schema-service');
  if (!el) return;
  
  el.textContent = JSON.stringify({
    "@context": "https://schema.org",
    "@type": "Service",
    "serviceType": "Jasa Konstruksi",
    "provider": {
      "@type": "LocalBusiness",
  ...
  console.log('[Main] ✅ Fallback schema injected');
}

// ============================================================
// 3. FUNGSI MENUNGGU SCHEMA SIAP
// ============================================================
function waitForSchemaReady(timeout = 8000) {
  return new Promise((resolve) => {
    ...
    const check = () => {
      ...
      if (Date.now() - start > timeout) {
        console.warn('[Main] ⏰ Schema timeout');
        resolve();
        return;
      }
...
async function main() {
  ...
  // Load schema
  await loadSchemaScript();
  
  // Tunggu schema siap
  await waitForSchemaReady();
  
  // ===== KODE UTAMA ANDA DI SINI =====
  console.log('[Main] ✅ Everything ready, executing main code...');
  
  // Contoh: tambahkan tracking, analytics, atau fungsi lain
  // ... kode Anda ...
...
if (urlMappingHargaJasaBorBetonFromMoneyPageMoneyChild[cleanUrlJasaPengeboranPost]) {
      generateBreadcrumbJasaPengeboranPost(
        urlMappingHargaJasaBorBetonFromMoneyPageMoneyChild,
        cleanUrlJasaPengeboranPost,
        [
...
if (urlMappingJasaBorTanahFromMoneyMaster1MoneyPage[cleanUrlJasaPengeboranPost]) {
  ...
  if (urlMappingJasaBorTanahDalamFromMoneyPageMoneyChild[cleanUrlJasaPengeboranPost]) {
      generateBreadcrumbJasaPengeboranPost(
        urlMappingJasaBorTanahDalamFromMoneyPageMoneyChild,
        cleanUrlJasaPengeboranPost,
        [
...
if (urlMappingJasaBorePileFromMoneyMaster1MoneyChild[cleanUrlJasaPengeboranPost]) {
       generateBreadcrumbJasaPengeboranPost(
        urlMappingJasaBorePileFromMoneyMaster1MoneyChild,
        cleanUrlJasaPengeboranPost,
        [
...
if (urlMappingJasaBorHorizontalFromMoneyMaster1MoneyChild[cleanUrlJasaPengeboranPost]) {
   ...
   if (urlMappingJasaTukangBorFromMoneyMaster1MoneyChild[cleanUrlJasaPengeboranPost]) {
        generateBreadcrumbJasaPengeboranPost(
        urlMappingJasaTukangBorFromMoneyMaster1MoneyChild,
        cleanUrlJasaPengeboranPost,
        [
